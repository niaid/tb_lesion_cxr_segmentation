...
"""
This network has been taken from https://github.com/usuyama/pytorch-unet.
...
class ResNetUNet(nn.Module):
    def __init__(self, n_class):
        ...
        self.layer0_1x1 = convrelu(64, 64, (1, 1, 1), (0, 0, 0))
        ...
        self.conv_up3 = convrelu(256 + 512, 512, (3, 3, 3), (1, 1, 1))
        self.conv_up2 = convrelu(128 + 512, 256, (3, 3, 3), (1, 1, 1))
        self.conv_up1 = convrelu(64 + 256, 256, (3, 3, 3), (1, 1, 1))
        self.conv_up0 = convrelu(64 + 256, 128, (3, 3, 3), (1, 1, 1))

        self.conv_original_size1 = convrelu(64, 64, (3, 3, 3), (1, 1, 1))
        self.conv_original_size2 = convrelu(64 + 128, 64, (3, 3, 3), (1, 1, 1))
