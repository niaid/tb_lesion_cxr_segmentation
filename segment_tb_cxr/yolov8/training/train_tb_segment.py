...
def train_model(pretrained_weights, yaml_file, model_info):
    ...
    model.train(
        ...
        imgsz=model_info["img_size"],
        name=model_info["name"],
        fliplr=model_info["fliplr"],
    )
...
def main():
    ...
    train_model(args.pretrained_weights, args.yaml_file, model_info)
